...
const projects = [
  ...
  {
    id: 2,
    title: "KwaNongoma Project",
    category: "Residential",
    location: "KwaNongoma, Zululand",
    year: "2026",
    description:
  ...
  },
  {
    ...
    category: "Residential",
    location: "Ndwedwe, Durban",
    year: "2026",
    description:
      "Plumbing services for a residential property, ensuring all installations meet safety and quality standards.",
    image: "/images/projects/project-45.jpeg",
    featured: false,
  },
  {
    id: 5,
    title: "KwaNdengezi Project",
    category: "Residential",
    location: "KwaNdengezi, Durban",
    year: "2026",
    description:
      "Plumbing services for a residential property, ensuring all installations meet safety and quality standards.",
  ...
  {
    id: 6,
    title: "Ethekwini College",
    category: "Commercial",
    location: "Umbilo Campus, Durban ",
    year: "2026",
    description:
      "Aluminium door installation for a commercial property, ensuring security and aesthetic appeal.",
    image: "/images/projects/project-47.jpeg",
    featured: false,
  },
];
